...
//            {/* logo */}
//            <Link to ="/" className = "text-2xl font-bold text-blue-700 flex items-center gap-2">Library Management</Link>
...
const Navbar = () => {
  ...
  return (
    <>
      <header className="w-full bg-blue-300 fixed top-0 left-0 right-0">
